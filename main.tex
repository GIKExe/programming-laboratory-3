...
\begin{document}
  ...
  \input{solutions.tex}
	...
	\section*{Выводы}
	Во время выполнения лабораторной работы научился писать функции, передавать в них аргументы по ссылке или значению и возвращать из них результат. В программе был реализованн простой пользовательский интерфейс в котором пользователь вводит пределы и разбиение. Также имеется функция для вычисления интеграла и оценки ошибки. Взаимодействие с пользователем реализованно в форме case-меню.
